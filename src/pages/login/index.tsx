    ...
    <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-10 bg-background text-foreground transition-colors duration-200">
        ...
        <div className="w-full max-w-sm sm:max-w-md mx-auto my-auto py-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault()
                    alert("Tautan pemulihan kata sandi telah dikirim ke email terdaftar Anda.")
                  }}
            ...
            <button
              ...
              className="w-full h-11 rounded-xl border border-border bg-background hover:bg-muted/60 text-foreground font-medium text-sm transition-colors flex items-center justify-center gap-3 cursor-pointer shadow-2xs"
            >
      ...
      >
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-between p-10 lg:p-14 xl:p-16 pointer-events-none">
          ...
          {/* Bagian Bawah: Deskripsi Teks + Titik Pagination Horizontal (Sesuai Referensi Gambar) */}
